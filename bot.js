...
client.on('ready', async () => {
 ...
 client.user.setActivity(`Zion  💚 LSPD`, { type:'WATCHING' })
...
antispam(client, {
  ...
  aralık: 100, // ms kullanıcılarda zaman miktarı, yasaklanmadan önce aralık değişkeninin maksimumunu gönderebilir.
  ...
  maxSpamBan: 5, //Bir kullanıcının yasaklanmadan önce bir zaman diliminde gönderebildiği maksimum kopya sayısı
